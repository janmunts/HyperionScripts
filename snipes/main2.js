    ...
    login() {
        chrome.storage.local.get(["websites"], function (result) {
            if (result.websites.snipes.profile) {
                ...
                passwordElement.value = result.websites.snipes.profile.password;
    ...
    checkout: {
        ...
        placeOrder() {
            const placeOrderButtonClick = setInterval(function () {
                if (
                    document.querySelector("[value='place-order']").disabled !==
                    true
                ) {
...
const requests = {
    ...
    login() {
        ...
        chrome.storage.local.get(["websites", "settings"], function (result) {
            fetch(
                `https://www.snipes${requests.regionData.snipesRegion}/authentication?rurl=2&format=ajax`,
                {
                    headers: {
                        accept: "application/json, text/javascript, */*; q=0.01",
                        "accept-language": "en,ca;q=0.9,es;q=0.8",
                ...
                .then((data) => {
                    if (data.success === true) {
                        ...
                        if (
                            result.settings.features.autoLogin.snipes === true
                        ) {
                            chrome.storage.local.get(
                                ["features"],
                                function (result) {
    ...
    product: {
        ...
        sizes: {
            ...
            select() {
                ...
                safe.product.sizes.list.forEach((size) => {
                    if (
                        size.className.includes("b-swatch-value--orderable") &&
                        !size.className.includes("b-swatch-value--sold-out")
                    ) {
                        safe.product.sizes.available.list.push(size);
                    } else {
    ...
    checkout: {
        ...
        shipping: {
            ...
            getAddressID() {
                ...
                fetch(
                    ...
                    .then((data) => {
                        ...
                        console.log(requests.checkout.shipping.customerProfile);
                        ...
                        if (data.customer.registeredUser) {
                            ...
                            requests.checkout.shipping.select();
                        } else {
                            console.error(
                            ...
                            if (requests.checkout.shipping.attempts < 3) {
                                chrome.storage.local.get(
                                    ...
                                    function (result) {
                                        const oldSettings = result.settings;
                                        oldSettings.features.autoLogin.snipes = true;
                                        chrome.storage.local.set(
                                            {
                                                settings: oldSettings,
                                            },
            ...
            select() {
                console.log(
                    `%cHyperionScripts - Selecting shipping...`,
                    "color: rgb(206, 182, 102); font-size: 12px"
                );
                fetch(
                    "https://www.snipes.es/on/demandware.store/Sites-snse-SOUTH-Site/es_ES/CheckoutShippingServices-SelectShippingMethod?format=ajax",
                    {
                        ...
                        referrer: location.toString(),
                        referrerPolicy: "strict-origin-when-cross-origin",
                        body: `methodID=${requests.regionData.delivery}&shipmentUUID=${requests.checkout.shipping.shipUUID}`,
                        method: "POST",
                        mode: "cors",
                        credentials: "include",
                    }
                    ...
                    .then((data) => {
                        console.log(data);
                        console.log(
                            `%cHyperionScripts - %cSuccessfully selected shipping!`,
                            "color: rgb(206, 182, 102); font-size: 12px",
                            "color: rgb(100, 200, 0); font-size: 12px"
                        );
                        requests.checkout.shipping.validate();
                    });
            },
            validate() {
                fetch(
                    "https://www.snipes.es/on/demandware.store/Sites-snse-SOUTH-Site/es_ES/CheckoutAddressServices-Validate?format=ajax",
                    {
                        headers: {
                            accept: "application/json, text/javascript, */*; q=0.01",
                            "accept-language": "en,ca;q=0.9,es;q=0.8",
                        ...
                        referrer: location.toString(),
                        referrerPolicy: "strict-origin-when-cross-origin",
                        body: `street=${requests.checkout.shipping.customerProfile.address1.replace(
                            " ",
                            "+"
                        )}&houseNo=${requests.checkout.shipping.customerProfile.suite.replace(
                            " ",
                            "+"
                        )}&postalCode=${requests.checkout.shipping.customerProfile.postalCode.replace(
                            " ",
                            "+"
                        )}&city=${requests.checkout.shipping.customerProfile.city.replace(
                            " ",
                            "+"
                        )}&country=${
                            requests.checkout.shipping.customerProfile
                ...
                chrome.storage.local.get(["websites"], function (result) {
                    fetch(
                        `https://www.snipes${requests.regionData.snipesRegion}/on/demandware.store/${requests.regionData.dwRegion}/${requests.regionData.snipesRegion2}/CheckoutShippingServices-SubmitShipping?format=ajax`,
                        {
                            ...
                            referrer: location.toString(),
                            referrerPolicy: "strict-origin-when-cross-origin",
                            body: `originalShipmentUUID=${requests.checkout.shipping.shipUUID}&shipmentUUID=${requests.checkout.shipping.shipUUID}&dwfrm_shipping_shippingAddress_shippingMethodID=home-delivery_es&address-selector=ab_ik83-a3i3-8h71-3dj0-3d35-b3ld&dwfrm_shipping_shippingAddress_addressFields_title=Herr&dwfrm_shipping_shippingAddress_addressFields_firstName=Jan&dwfrm_shipping_shippingAddress_addressFields_lastName=Munts&dwfrm_shipping_shippingAddress_addressFields_postalCode=08250&dwfrm_shipping_shippingAddress_addressFields_city=Sant+Joan+de+Vilatorrada&dwfrm_shipping_shippingAddress_addressFields_street=Maria+Aurelia+Capmany+31+1o+2a&dwfrm_shipping_shippingAddress_addressFields_suite=31&dwfrm_shipping_shippingAddress_addressFields_address1=Maria+Aurelia+Capmany+31+1o+2a%2C+31&dwfrm_shipping_shippingAddress_addressFields_address2=&dwfrm_shipping_shippingAddress_addressFields_phone=&dwfrm_shipping_shippingAddress_addressFields_countryCode=ES&dwfrm_shipping_shippingAddress_shippingAddressUseAsBillingAddress=true&dwfrm_billing_billingAddress_addressFields_title=Herr&dwfrm_billing_billingAddress_addressFields_firstName=Jan&dwfrm_billing_billingAddress_addressFields_lastName=Munts&dwfrm_billing_billingAddress_addressFields_postalCode=08250&dwfrm_billing_billingAddress_addressFields_city=Sant+Joan+de+Vilatorrada&dwfrm_billing_billingAddress_addressFields_street=Maria+Aurelia+Capmany+31+1o+2a&dwfrm_billing_billingAddress_addressFields_suite=31&dwfrm_billing_billingAddress_addressFields_address1=Maria+Aurelia+Capmany+31+1o+2a%2C+31&dwfrm_billing_billingAddress_addressFields_address2=&dwfrm_billing_billingAddress_addressFields_countryCode=ES&dwfrm_billing_billingAddress_addressFields_phone=&dwfrm_contact_email=janmuntsiglesias%40gmail.com&dwfrm_contact_phone=&csrf_token=${requests.checkout.CSRFtoken}`
